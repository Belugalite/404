...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await idk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await idk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await idk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await ydk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await ydk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await ydk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await wdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await wdk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await wdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await hdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await hdk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await hdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await sdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await sdk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await sdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await adk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await adk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await adk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await bdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await bdk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await bdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await cdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await cdk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await cdk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await ddk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await ddk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await ddk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await edk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await edk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await edk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await vkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await vkk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await vkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await kkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await kkk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await kkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await lkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await lkk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await lkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await mkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await mkk(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await mkk(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await sid(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await sid(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await sid(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await shy(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await shy(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await shy(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await aan(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await aan(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await aan(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await ake(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await ake(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await ake(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await eel(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await eel(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await eel(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await khu(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await khu(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await khu(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await shi(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await shi(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await shi(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await yaa(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await yaa(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await yaa(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await dav(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await dav(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await dav(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await raj(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await raj(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await raj(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            await put(functions.channels.JoinChannelRequest(channel="@ELITEBOY_CHAT"))
            await put(functions.channels.JoinChannelRequest(channel="@ELITES_DPS_BGZ"))
            await put(functions.channels.JoinChannelRequest(channel="@ELITEBOY_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
